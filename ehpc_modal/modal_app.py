...
BENCHMARK_ENTRYPOINTS = {
    "pilot": "ehpc_modal.pilot",
    "longbench": "ehpc_modal.benchmark_longbench",
    "repobench": "ehpc_modal.benchmark_repobench",
    "suite": "ehpc_modal.benchmark_suite",
}
...
def _modal_objects():
    ...
    def build_image(requirements_name: str):
        return (
            ...
            .add_local_python_source("latent_rollback_modal", "ehpc_modal")
        )
...
if app is not None:
    ...
    def run_pilot(args: list[str] | None = None):
        return _run_benchmark_payload("pilot", args)
